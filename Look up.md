...
![escaneo nmap](images/20251030130420.png)

![resultado nmap detalle](images/20251030130706.png)

vemos que nos esta redirigiendo a otra pagina, vamos a agregarla al /etc/hosts

![redirección / hosts](images/20251030131131.png)

vemos que estamos en en una pagina llamada elFinder

![elfinder pagina](images/20251030131218.png)

vemos que la version es la 2.1.47 vamos a ver cuales vulnerabilidades hay para esa version

![version elfinder 2.1.47 - 1](images/20251030131919.png)  
![version elfinder 2.1.47 - 2](images/20251030131945.png)

utilizamos metaesploit y vemos esto

![metasploit exploit info](images/20251030132941.png)

tenemos que poner la opcion RHOSTS en  files.lookup.thm y la LHOSTS a nuestra ip

![metasploit RHOSTS LHOSTS](images/20251030133357.png)



![meterpreter ejecución](images/20251030133428.png)  
...
![etc passwd muestra usuarios](images/20251030133721.png)

vamos a chequear el directorio de think

![listar home think - 1](images/20251030134530.png)



![listar home think - 2](images/20251030134809.png)

hay un archivo .passwords pero no lo podemos leer porque no tenemos permisos

vamos a buscar binarios SUID  
![busqueda binarios SUID - 1](images/20251030135239.png)  
![busqueda binarios SUID - 2](images/20251030135228.png)

hay un archivo /usr/sbin/pwm que se escapa dentro de lo default de linux

![pwm en /usr/sbin](images/20251030135436.png)

este archivo pertenece a root

vamos a ver que pasa cuando lo ejecutamos

![ejecución pwm muestra output](images/20251030135542.png)
